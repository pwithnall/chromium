...
#ifndef CONTENT_RENDERER_MEDIA_GSTREAMER_WEBMEDIAPLAYER_GST_H_
#define CONTENT_RENDERER_MEDIA_GSTREAMER_WEBMEDIAPLAYER_GST_H_
...
// Encrypted Media.
class WebMediaPlayerGst
    : public blink::WebMediaPlayer,
      public base::SupportsWeakPtr<WebMediaPlayerGst> {
 public:
  // Constructs a WebMediaPlayer implementation using Chromium's media stack.
  // |delegate| may be null.
  WebMediaPlayerGst(blink::WebLocalFrame* frame,
                    blink::WebMediaPlayerClient* client,
                    base::WeakPtr<WebMediaPlayerDelegate> delegate,
                    const WebMediaPlayerParams& params);
  virtual ~WebMediaPlayerGst();
 ...
 private:
  ...
  DISALLOW_COPY_AND_ASSIGN(WebMediaPlayerGst);
};

}  // namespace content

#endif  // CONTENT_RENDERER_MEDIA_GSTREAMER_WEBMEDIAPLAYER_GST_H_
